...
namespace UIProbe
{
    ...
    {
        // Indexer State
        // 共享索引数据（allPrefabs / folderTree / isIndexBuilt / indexRootPath /
        // lastIndexUpdateTime / prefabIndexVersion）已迁入 PrefabIndexService，
        // 壳层 UIProbeWindow 提供同名 shim 属性，过渡期消费者编译不变。
        ...
        // AssetReference / PrefabIndexItem / FolderNode 已提升为 PrefabIndexService.cs
        // 中的 internal 顶层类型（同 UIProbe 命名空间，按简单名解析，消费者无需改动）。
        ...
        // 索引缓存 I/O（GetIndexCachePath / SaveIndexCache / LoadIndexCache 及其
        // ConvertToSerializable / ConvertFolderToSerializable / CollectFoldersFlattened /
        // ConvertFromSerializable 转换器）已迁入 PrefabIndexService。
