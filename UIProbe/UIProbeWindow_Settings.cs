    ...
    public partial class UIProbeWindow
    {
        ...
        private void DrawSettingsTab()
        {
            ...
            if (showModulesVisibility && config != null)
            {
                ...
                config.modulesVisibility.showAnimationAutoRepair = EditorGUILayout.ToggleLeft("动画路径自动修复 (Animation Auto Repair)", config.modulesVisibility.showAnimationAutoRepair);
